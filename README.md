...
> Documentation is completed in the final phase of the project. See [`plan.md`](./plan.md) for the high-level plan and [`execution-plan.md`](./execution-plan.md) for the commit-by-commit execution checklist.
...
In progress — see the planning files for the roadmap.